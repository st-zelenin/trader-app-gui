...
export const setBuyMultiplicator = createAction(ACTIONS.SET_BUY_MULTIPLICATOR, props<{ buyMultiplicator: Multiplicator }>());

export const setOrderDefaultTotalAmount = createAction(ACTIONS.SET_ORDER_DEFAULT_TOTAL_AMOUNT, props<{ total: number }>());

export const setDefaultSellVolumeDivider = createAction(ACTIONS.SET_DEFAULT_SELL_VOLUME_DIVIDER, props<{ divider: number }>());
