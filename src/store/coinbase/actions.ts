...
export enum ACTIONS {
  ...
  GET_RECENT_BUY_AVERAGES = '[coinbase][Recent] get recent buy averages',
  GET_RECENT_BUY_AVERAGES_ERROR = '[coinbase][Recent] get recent buy averages error',
  SET_RECENT_BUY_AVERAGES = '[coinbase][Recent] set recent buy averages',
}
