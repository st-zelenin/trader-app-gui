  ...
  providers: [
    ...
    },
    {
      ...
      useFactory: () => {
        ...
        protectedResourceMap.set(API_URL_USER, [environment.API_SCOPE]);
        protectedResourceMap.set(API_URL, [environment.API_SCOPE]);
        protectedResourceMap.set(API_URL_CRYPTO, [environment.API_SCOPE]);
